 ...
 **/
class HomeNewsViewHolder(itemView: View,val  delegate: NewsItemDelegate ) : BaseViewHolder<NewsVO>(itemView) {
    ...
    override fun setData(data: NewsVO) {
        ...
        if(data.urlToImage == null){
            itemView.ivNews.visibility  = GONE
        }else{
            itemView.ivNews.visibility = VISIBLE
